...
export const waterDamageData: ServicePageData = {
  ...
  whatItIs: 'Water damage happens when unwanted moisture enters your property and affects building materials, belongings, or indoor air quality. Even a small leak can lead to mould and structural damage within 24 to 48 hours. That\'s why Arctiv uses professional assessments and industrial-grade equipment to restore every property safely and effectively.',
  signs: [
  ...
  process: [
    { title: 'Emergency Assessment', desc: 'We inspect the damage, document the scope, and explain the restoration plan before any work begins.' },
    { title: 'Water Extraction', desc: 'Industrial extractors remove standing water and trapped moisture from surfaces and hidden cavities.' },
    { title: 'Structural Drying', desc: 'We use dehumidifiers and air movers, monitor moisture levels, and track drying progress to industry standards.' },
    { title: 'Restoration & Repair', desc: 'Once dry, we repair and replace damaged materials to restore your property to its pre-loss condition.' },
  ],
  benefits: [
    { title: 'Arrives Within the Hour', desc: 'Our on-call crews respond immediately to begin extraction before secondary damage occurs.' },
    { title: 'Insurance Billing Support', desc: 'We provide detailed photos, moisture logs, and reports to support your insurance claim.' },
    { title: 'IICRC-Certified Technicians', desc: 'Every restoration project follows IICRC S500 standards, the industry benchmark for water damage remediation.' },
    { title: 'One Team, Start to Finish', desc: 'From extraction to repairs, Arctiv manages every stage under one roof.' },
    { title: 'Mould Secondary Damage Prevention', desc: 'Our drying process removes excess moisture before mould has a chance to develop.' },
    { title: 'Advanced Moisture Mapping', desc: 'Thermal imaging and moisture meters detect hidden moisture before it causes further damage.' },
  ],
  faqs: [
...
export const fireDamageData: ServicePageData = {
  ...
  process: [
    { title: 'Site Handover & Initial Assessment', desc: 'Once the property is cleared for entry, we assess fire, smoke, soot, and water damage to define the restoration plan.' },
    { title: 'Forensic Investigation & Engineering Review', desc: 'Investigators determine the fire origin while engineers assess structural integrity and repair needs.' },
    { title: 'Documentation & Insurance Coordination', desc: 'We prepare reports, photos, and restoration scopes to support insurance review and approval.' },
    { title: 'Remediation & Reconstruction', desc: 'We remove damaged materials, clean affected areas, and complete repairs to restore your property safely and efficiently.' }
  ],
  benefits: [
    ...
    { title: 'Certified Restoration Technicians', desc: 'All fire and smoke work is performed by IICRC-certified technicians trained in Fire and Smoke Restoration.' },
  ...
  faqs: [
    { q: 'Can I stay in my home after a fire?', a: 'This depends on the extent of the fire and whether utilities have been made safe. Arctiv will advise you on this immediately after assessment. Smoke and soot in the air may be a health hazard, which is why our crew always uses PPE.' },
...
export const mouldRemediationData: ServicePageData = {
  ...
  process: [
    { title: 'Inspection & Testing', desc: 'Certified technicians assess mould growth, identify moisture sources, and collect samples for laboratory testing.' },
    { title: 'Containment Setup', desc: 'Containment barriers and negative air systems isolate the area to prevent spore spread during removal.' },
    { title: 'Removal & Treatment', desc: 'HEPA vacuuming, antimicrobial treatment, and safe removal of contaminated materials following industry standards.' },
    { title: 'Clearance Testing', desc: 'Post-remediation air and surface testing confirms mould levels are safe, with complete documentation provided.' },
  ],
  benefits: [
    { title: 'Health Canada & IICRC Compliant', desc: 'Our remediation process follows Health Canada and IICRC standards for safe mould removal and healthier indoor air.' },
    ...
    { title: 'Rapid Response Service', desc: 'Fast assessment and remediation limit contamination, reduce downtime, and minimize disruption.' },
    ...
    { title: 'Certified Technicians', desc: 'Our certified mould remediation specialists deliver safe and effective removal.' },
    { title: 'Air Quality Testing', desc: 'Pre- and post-remediation testing confirms a safe and healthy indoor environment.' },
  ],
  faqs: [
...
export const structuralDryingData: ServicePageData = {
  ...
  process: [
    { title: 'Moisture Assessment', desc: 'Thermal imaging, moisture meters, and psychrometric readings establish baseline moisture conditions.' },
    { title: 'Equipment Deployment', desc: 'Industrial dehumidifiers, air movers, and drying mats are positioned based on the drying plan and room layout.' },
    { title: 'Daily Monitoring', desc: 'Technicians record moisture readings, adjust equipment, and track drying progress to industry standards.' },
    { title: 'Verification & Documentation', desc: 'Final moisture readings confirm materials are dry, with complete documentation for insurance and records.' },
  ],
  benefits: [
    ...
    { title: 'Industrial Equipment', desc: 'Low-grain and desiccant dehumidifiers achieve target moisture levels efficiently.' },
    { title: 'Daily Documentation', desc: 'Daily moisture logs, photos, and reports keep you and your insurer informed throughout the process.' },
    { title: 'Mould Prevention', desc: 'Proper drying below 16% wood moisture content helps prevent mould growth.' },
    { title: 'Insurance Coordination', desc: 'We work directly with adjusters and provide the documentation needed for your claim.' },
    { title: 'Guaranteed Results', desc: 'We verify moisture levels meet acceptable standards before removing our equipment.' },
  ],
  faqs: [
...
export const stormDamageData: ServicePageData = {
  ...
  process: [
    { title: 'Emergency Response', desc: 'Immediate response with emergency tarping, board-ups, and temporary weatherproofing to prevent further damage.' },
    { title: 'Damage Assessment', desc: 'Comprehensive documentation of structural, water, and content damage to support your insurance claim.' },
    { title: 'Restoration & Repairs', desc: 'Coordinated repairs from roofing and structural elements to exterior systems and interior finishes.' },
    { title: 'Final Inspection', desc: 'Final quality inspection ensures all work meets building codes and your expectations before sign-off.' },
  ],
  benefits: [
    { title: '24/7 Emergency Response', desc: 'Our emergency crews are available 24/7 to respond quickly when storm damage occurs.' },
    { title: 'Full-Service Restoration', desc: 'From emergency tarping to complete rebuilds, one team manages every stage of storm recovery.' },
    { title: 'Insurance Expertise', desc: 'We provide the documentation and expertise needed to support your storm damage insurance claim.' },
    { title: 'Structural Assessment', desc: 'We coordinate with insurance-assigned structural engineers to assess and address compromised structures.' },
    { title: 'Weatherproofing Priority', desc: 'Temporary repairs help prevent secondary water damage while permanent repairs are underway.' },
    { title: 'Code-Compliant Rebuilds', desc: 'Every reconstruction project meets or exceeds current Ontario Building Code requirements.' },
  ],
  faqs: [
...
export const sewageCleanupData: ServicePageData = {
  ...
  heroDesc: 'Sewage backups are serious biohazard events that require immediate professional response. Arctiv provides safe, thorough sewage cleanup and restoration, protecting both your health and your property.',
  ...
  process: [
    { title: 'Emergency Containment', desc: 'Immediate isolation of affected areas, source control where possible, and safety measures for occupants.' },
    { title: 'Extraction & Removal', desc: 'Safe removal of sewage water and contaminated materials using specialized equipment.' },
    { title: 'Sanitization & Deodorization', desc: 'Thorough cleaning, antimicrobial treatment, and odour removal for all affected surfaces and materials.' },
    { title: 'Restoration & Rebuild', desc: 'Replacement of damaged materials and full restoration to return your property to a safe, habitable condition.' },
  ],
  benefits: [
    { title: 'Specialized Sewage Cleanup', desc: 'We follow industry-standard procedures for the safe cleanup and restoration of sewage-damaged properties.' },
    { title: 'Health Protection', desc: 'Proper containment, PPE, and sanitization protocols protect occupants and workers from harmful pathogens.' },
    { title: 'Complete Documentation', desc: 'Complete photo and written documentation supports insurance claims and verifies safe restoration standards.' },
    { title: 'Proper Disposal', desc: 'All contaminated materials are disposed of in accordance with Ontario biohazard regulations.' },
    { title: 'Odour Elimination', desc: 'Advanced deodorization removes sewage odours at the source, not just masks them.' },
    { title: 'Insurance Coordination', desc: 'We work directly with insurers to streamline sewage damage claims and documentation.' },
  ],
  faqs: [
...
export const repairsRenovationData: ServicePageData = {
  ...
  process: [
    { title: 'Assessment & Scope', desc: 'A detailed assessment defines the repair scope, renovation needs, and project timeline.' },
    { title: 'Design & Selection', desc: 'Choose materials, colors, and finishes with guidance from our renovation specialists.' },
    { title: 'Construction', desc: 'Our team coordinates everything from framing and drywall to electrical, plumbing, flooring, and finishing.' },
    { title: 'Final Walkthrough', desc: 'A final inspection and walkthrough ensure every detail meets our standards and your expectations.' },
  ],
  benefits: [
...
export const generalContractingData: ServicePageData = {
  ...
  whatItIs: 'General contracting involves the complete coordination and management of a construction or renovation project. As your general contractor, Arctiv handles all aspects of the project, including hiring and scheduling subcontractors, obtaining permits, ordering materials, managing timelines and budgets, and ensuring quality control throughout. Whether it is a new addition, a commercial tenant improvement, or a large-scale renovation, we bring the expertise and organization needed to deliver on time and on budget.',
  signs: [
    { label: 'Complex Project', desc: 'Multiple trades and phases requiring professional coordination' },
    { label: 'Permit Requirements', desc: 'Your project may require building permits and inspections' },
  ...
  process: [
    { title: 'Planning & Permits', desc: 'Detailed project planning, permits, and material procurement completed before work begins.' },
    { title: 'Trade Coordination', desc: 'Coordinated scheduling of subcontractors to keep the project efficient and on track.' },
    { title: 'Quality Control', desc: 'Phase-by-phase inspections ensure quality workmanship and code compliance.' },
    { title: 'Project Completion', desc: 'Final inspections, deficiency corrections, and complete cleanup before handover.' },
  ],
  benefits: [
  ...
  faqs: [
    ...
    { q: 'Do you handle permits and inspections?', a: 'Yes, permit application and coordination of all required inspections are included in our general contracting services.' },
