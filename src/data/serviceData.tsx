...
export const waterDamageData: ServicePageData = {
  ...
  process: [
    ...
    { title: 'Structural Drying', desc: 'We deploy dehumidifiers, air movers and drying mats. Daily moisture logs track progress to IICRC S500 drying goals.' },
...
export const fireDamageData: ServicePageData = {
  ...
  process: [
    { title: 'Emergency Board-Up & Securing', desc: 'We protect the structure immediately — boarding windows, tarping the roof, and restricting access to prevent further loss.' },
    { title: 'Scope & Documentation', desc: 'Full photo documentation, contents inventory, and a detailed scope of work to support your insurance claim from day one.' },
    { title: 'Cleaning & Deodorization', desc: 'Soot removal from all surfaces using dry cleaning sponges, chemical sponges, and HEPA vacuuming, followed by thermal fogging and ozone treatment.' },
    { title: 'Structural Restoration', desc: 'Damaged framing, drywall, insulation, flooring, and finishes are replaced by our in-house reconstruction crews.' },
  ],
  benefits: [
...
export const mouldRemediationData: ServicePageData = {
  ...
  signs: [
    ...
    { label: 'Health Symptoms', desc: 'Allergies, respiratory issues, or headaches that improve when away from the property' },
  ],
  process: [
    { title: 'Inspection & Testing', desc: 'Certified inspectors assess the extent of mould growth, identify moisture sources, and collect samples for laboratory analysis.' },
  ...
  benefits: [
    { title: 'Health Canada Compliant', desc: 'All remediation follows Health Canada guidelines for safe mould removal and indoor air quality restoration.' },
    ...
    { title: 'Root Cause Resolution', desc: 'We identify and address the moisture source, not just the mould, to prevent recurrence.' },
    ...
    { title: 'Certified Technicians', desc: 'Our mould remediation specialists hold IICRC and ACAC certifications for safe, effective removal.' },
  ...
  faqs: [
    ...
    { q: 'Is mould dangerous?', a: 'Some mould species can cause allergic reactions, respiratory issues, and other health problems. The elderly, children, and those with compromised immune systems are most at risk. Prompt professional remediation is recommended.' },
    { q: 'How long does mould remediation take?', a: 'Most residential mould remediation projects are completed in 3–7 days. Larger commercial projects or extensive colonization may take longer. Your project manager will provide a specific timeline after assessment.' },
    { q: 'Will mould come back after remediation?', a: 'If the underlying moisture issue is resolved and proper remediation is performed, mould should not return. We identify and address moisture sources as part of our comprehensive approach.' },
  ],
  relatedServices: [
    { label: 'Water Damage', path: '/services/water-damage' },
    { label: 'Structural Drying', path: '/services/structural-drying' },
...
export const structuralDryingData: ServicePageData = {
  ...
  process: [
    { title: 'Moisture Assessment', desc: 'Comprehensive moisture mapping using thermal imaging, penetrating meters, and psychrometric readings to establish baseline conditions.' },
  ...
  benefits: [
    ...
    { title: 'Guaranteed Results', desc: 'We verify drying with third-party moisture readings before demobilizing equipment.' },
  ],
  faqs: [
    ...
    { q: 'How do you know when something is truly dry?', a: 'We use penetrating moisture meters, thermal imaging, and psychrometric calculations to determine when materials have reached their equilibrium moisture content — the point at which they are as dry as the surrounding air.' },
...
export const stormDamageData: ServicePageData = {
  ...
  process: [
    ...
    { title: 'Restoration & Repairs', desc: 'Coordinated repair of all damaged systems — roofing, exterior envelope, structural elements, and interior finishes.' },
  ...
  benefits: [
    ...
    { title: 'Structural Assessment', desc: 'Our team includes structural engineers who can assess and address compromised structural elements.' },
  ...
  faqs: [
    { q: 'How quickly can you respond to storm damage?', a: 'We provide 24/7 emergency response for storm damage. Our goal is to have crews on-site within 2–4 hours for the Greater Toronto Area to perform emergency temporary repairs and prevent further damage.' },
...
export const sewageCleanupData: ServicePageData = {
  ...
  benefits: [
    { title: 'Biohazard Certified', desc: 'Our technicians are trained and equipped for safe handling of Category 3 water damage and biohazard materials.' },
  ...
  faqs: [
    ...
    { q: 'Can I clean up sewage myself?', a: 'We strongly recommend against attempting sewage cleanup yourself. Professional equipment, training, and proper disposal are essential for safe and effective remediation. Exposure to sewage can cause serious health problems.' },
  ],
  relatedServices: [
    { label: 'Water Damage', path: '/services/water-damage' },
    { label: 'Mould Remediation', path: '/services/mould-remediation' },
...
export const repairsRenovationData: ServicePageData = {
  ...
  process: [
    ...
    { title: 'Construction', desc: 'Coordinated construction by our in-house trades — framing, drywall, electrical, plumbing, flooring, and finishing.' },
